...
console.log("Total using forEach:", totalAmount);


// using reduce do the same

const totalAmountWithReduce = shoppingCart.reduce((total, item) => {
  return total + item.quantity * item.price;
}, 0);

console.log("Total using reduce:", totalAmountWithReduce);
